...
const mongooseSchema = require('../services/group/group.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const group = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['group']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('group', group);
