...
const mongooseSchema = require('../services/contact/contact.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const contact = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['contact']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('contact', contact);
